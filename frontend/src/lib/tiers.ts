...
export const TIER_CONFIG: Record<TierLevel, TierInfo> = {
  0: {
    ...
    description: "Just getting started on your influencer journey",
    minCollabs: 0,
    emoji: "🌱",
  },
  1: {
    ...
    description: "Exploring opportunities and building your portfolio",
    minCollabs: 3,
    emoji: "🧭",
  },
  2: {
    ...
    description: "Professional creator with proven track record",
    minCollabs: 10,
    emoji: "⭐",
  },
  3: {
    ...
    description: "Elite influencer with premium access",
    minCollabs: 25,
    emoji: "💎",
  },
  4: {
    ...
    description: "Master of the craft with exceptional influence",
    minCollabs: 50,
    emoji: "👑",
  },
  5: {
    ...
    description: "Legendary status - the pinnacle of achievement",
    minCollabs: 100,
    emoji: "🏆",
  },
};
